...
export function SampleTestApp() {
  return <main className="sample-test-app">
    <header className="topbar"><a className="wordmark" href="/samples"><span className="brand-icon">H</span>Holospex</a><span className="prototype-tag">Overlay test page</span></header>
